<template>
    <section id='foot_guide'>
        ...
        <section @click="gotoAddress({path:'/search',query:{geohash}})" class="guide_item">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('search') !== -1? '#findActive':'#find' "></use>
            </svg>
            <span>搜索</span>
        </section>
        <section @click="gotoAddress({path:'/order',query:{geohash}})" class="guide_item">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('order') !== -1? '#orderActive':'#order' "></use>
            </svg>
            <span>订单</span>
        </section>
        <section @click="gotoAddress({path:'/profile',query:{geohash}})" class="guide_item">
            <svg class="icon_style">
